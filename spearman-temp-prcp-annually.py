...
plt.title('Annual Temperature-Precipitation Correlation (1950-2024)', fontsize=30)
plt.text(0.05, 0.91, f'Spearman Correlation Coefficient: {r:.4f}\nP-value: {p_value:.4f}', transform=plt.gca().transAxes, fontsize=20, verticalalignment='top')
